/*
	Edited version of STRML/textFit util (https://github.com/STRML/textFit)
	- improved accuracy of height setting when aligning spans vertically
*/
window.Utils = window.Utils || {};
Utils.textFit = (function() {
  'use strict';
  ...
  function processItem(el, settings) {
    ...
    if (settings.alignVert) {
      addStyleSheet();
      // set position: absolute w/ 0 left and right
      // by setting 'textFitAlignHoriz' classname
      // to update dimensions rendered by this type of alignment
      if (!hasClass(innerSpan, 'textFitAlignHoriz')) {
